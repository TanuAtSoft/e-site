...
export default function UserSellerTable({ orderedItems, handleRefetch }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div style={{ display: "flex", flexDirection: "column" }}>
           {params.row.verificationDoc ? <ContentPasteSearchOutlinedIcon/> : <ContentPasteOffOutlinedIcon/>}
          </div>
        );
      },
    },
